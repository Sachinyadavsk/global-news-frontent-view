                            ...
                            <div className="">
                                {postsDetails.length === 0 ? (
                                    <p className="col-span-full text-center text-gray-500">
                                        No posts details found
                                    </p>
                                ) : (
                                        <div key={postsDetails._id} className="card bg-base-100 shadow-md hover:shadow-lg transition">
                                            <figure>
                                                {postsDetails.video_path ? (
                                                    <video
                                                        src={postsDetails.video_path}
                                                        poster={postsDetails.image_big}
                                                        controls
                                                        className="h-full w-full object-cover"
                                                    />
                                                ) : (
                                                    <img
                                                        src={postsDetails.image_big || "https://via.placeholder.com/300"}
                                                        alt={postsDetails.title}
                                                        className="h-full w-full object-cover"
                                                    />
                                                )}
                                            </figure>
